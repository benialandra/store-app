...
const translations: Record<Locale, Record<string, string>> = {
  id: {
    ...
    'track.status.pending': 'Menunggu Pembayaran',
    'track.status.success': 'Berhasil',
    'track.status.failed': 'Gagal',
    'track.status.expired': 'Kedaluwarsa',
    'track.res.product': 'Produk',
    'track.res.code': 'Kode Akses',
    'track.res.email': 'Email',
    'track.res.date': 'Tanggal',
    'track.res.active': '✅ Link download Anda masih aktif. Cek email Anda atau klik tombol di bawah.',
    'track.res.expired_msg': '⚠️ Link download Anda sudah kedaluwarsa atau sudah digunakan. Hubungi admin untuk mendapatkan link baru.',
    'track.err.network': 'Gagal menghubungi server.',
    'track.err.unknown': 'Terjadi kesalahan.',
  ...
  en: {
    ...
    'track.status.pending': 'Waiting for Payment',
    'track.status.success': 'Success',
    'track.status.failed': 'Failed',
    'track.status.expired': 'Expired',
    'track.res.product': 'Product',
    'track.res.code': 'Access Code',
    'track.res.email': 'Email',
    'track.res.date': 'Date',
    'track.res.active': '✅ Your download link is still active. Check your email or click the button below.',
    'track.res.expired_msg': '⚠️ Your download link has expired or been used. Contact admin for a new link.',
    'track.err.network': 'Failed to connect to server.',
    'track.err.unknown': 'An error occurred.',
